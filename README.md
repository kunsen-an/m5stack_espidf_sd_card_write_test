...
m5stack core grey (https://m5stack.com/collections/m5-core/products/grey-development-core).

This program is used to measure write speed to a Micro SD card.
Please refer to https://kunsen.net for details.

The following is a slightly modified README.md
===
...
To run this example, m5stack is needed.
Only SPI mode is supported in m5stack.
The following shows SD card connections:

m5stack pin | SD card pin | SPI pin | Notes
------------|-------------|---------|------------
GPIO18      | CLK         | SCK     | 10k pullup
GPIO23      | CMD         | MOSI    | 10k pullup,  in  SPI modes
GPIO19      | D0          | MISO    | 10k pullup
N/C         | D1          |         | not used in m5stack
N/C         | D2          |         | not used in m5stack
GPIO4       | D3          | CS      | 
